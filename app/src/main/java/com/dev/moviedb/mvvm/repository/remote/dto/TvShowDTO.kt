...
class TvShowDTO() : Parcelable {
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeParcelableArray(genres, flags)
        parcel.writeStringArray(episodeRunTime)
        parcel.writeString(type)
        parcel.writeString(id)
        parcel.writeStringArray(languages)
        parcel.writeString(numberOfSeasons)
        parcel.writeString(lastAirDate)
        parcel.writeString(inProduction)
        parcel.writeString(name)
        parcel.writeString(popularity)
        parcel.writeParcelableArray(createdBy, flags)
        parcel.writeString(backdropPath)
        parcel.writeString(status)
        parcel.writeString(numberOfEpisodes)
