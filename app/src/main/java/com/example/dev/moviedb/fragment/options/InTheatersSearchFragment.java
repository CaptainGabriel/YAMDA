...
import com.example.dev.moviedb.views.adapters.ItemListAdapter;
 ...
 * related to the search of the movies that are currently playing in theaters accordingly
 * to the TMDB api.
 *
 ...
 * @version 0.0.2
 */
public class InTheatersSearchFragment extends AbstractSearchOptionsListFragment {
   ...
   */
  public static final String SAVE_ITEM_LIST_KEY = "InTheatersSearchFragment.item.key";
  ...
  @Override public void onListItemClick(ListView l, View v, int position, long id) {
    ...
    if (mClickedItemCallback != null) {
      mClickedItemCallback.onItemSelected(DataUnit.Tables.IN_THEATERS_TABLE,
              mItems.get(position));
    }
  }
